...
//        q[4].x = -31438.0846 ;q[4].y = 14771.1936 ;q[4].z = 27894.3347;
    ...
    unsigned int GMath::solveP3(double *x,double a,double b,double c)
    {
        double a2 = a*a;
        double q  = (a2 - 3*b)/9;
...
//        double B = sqrt(B2);
//        double C = sqrt(C2);
//        double D1 = (a+B)*(a+B) - 4*(A+C);
//        double D2 = (a-B)*(a-B) - 4*(A-C);
//        if(D1 < 0) // no real solution
//        {
//
//        }
//        else
//        {
//            if( fabs(D1) < eps) // one real solution
//            {
//                X[num_real] = -(a +B)*0.5;
//                num_real = num_real +1;
//
...
//        }
//
//        if(D2 < 0) // no real solution
//        {
//
//        }
//        else
//        {
//            if( fabs(D2) < eps) // one real solution
//            {
//                X[num_real] = -(a -B)*0.5;
//                num_real = num_real +1;
//            }
...
//            q1 = (y + sqD) * 0.5;
//            q2 = (y - sqD) * 0.5;
//            // p1+p2 = a && p1*q2 + p2*q1 = c       ( && g === p )  Krammer
//            p1 = (a*q1-c)/(q1-q2);
//            p2 = (a*q2-c)/(q1-q2);
//        }
//        else if (D < 0)

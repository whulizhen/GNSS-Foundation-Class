...
namespace gfc
{
    ...
    GEarthRadiationModel::GEarthRadiationModel()
    {
        ...
        m_ceresDataFile = m_dataDirectory + "CERES_SYN1deg-Month_Terra-Aqua-MODIS_Ed3A_Subset_200503-201503.nc";
...
//        }
    ...
    void GEarthRadiationModel::attachFlux(int imonth,int type)
    {
        ...
        for( int i = 0; i < m_level+1 ; i++ )
        {
            ...
            path = path + tmp1;
            path = path + "polygon.py";
            FILE*  polygonFile = fopen(path.c_str(),"w+");
    ...
    void GEarthRadiationModel::loadData()
    {
        ...
        for( int rec = 0 ; rec< dim_time_len; rec++ )
        {
            ...
            for( int i = 0 ; i< dim_lat_len; i++ )
            {
                ...
                {
                    m_monToaData[test][myct.m_month-1].data[i][j] += toaData[i][j];
                }
            }
        }
        ...
        for( int k =0 ; k< m_monToaData[test].size() ; k++ )
        {
            for( int i = 0 ; i<dim_lon_len; i++  ) //360
            {
                ...
                {
                    m_monToaData[test][k].data[j][i] = m_monToaData[test][k].data[j][i] / dataTag[k];
                }
            }
        }
